...
msos.console.info('ng/ui/router/v1019_msos -> start.');
...
(function (global, factory) {
    ...
    function getParamDeclaration(paramName, location, state) {
        var noReloadOnSearch = (state.reloadOnSearch === false && location === exports.DefType.SEARCH) || undefined,
			dynamic = [state.dynamic, noReloadOnSearch].find(isDefined),
    ...
    var ParamFactory = (function () {
        ...
        function ParamFactory(umf) { this.umf = umf; }
...
msos.console.info('ng/ui/router/v1019_msos -> done!');
