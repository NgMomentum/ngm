...
msos.provide("ng.material.v111.ui.input");
...
ng.material.v111.ui.input.version = new msos.set_version(17, 1, 12);
...
(function () {
    ...
    function getMessagesElement(element) {
        ...
        if (element.hasClass('md-input-message-animation')) {
            return angular.element($mdUtil_inp.getClosest(element, function (node) {
    ...
    angular.module(
        ...
        'mdSelectOnFocus',
        ["$timeout", mdSelectOnFocusDirective]
    ).animation(
        '.md-input-invalid',
