...
msos.provide("ng.material.v111.ui.icon");
msos.require("ng.material.v111.core");
msos.require("ng.material.v111.core.theming");
msos.require("ng.material.v111.ui.aria");

ng.material.v111.ui.icon.version = new msos.set_version(16, 12, 29);

ng.material.v111.ui.icon.config = {
...
function MdIconProvider() {
	...
	msos.console.debug('ng.material.v111.ui.icon - MdIconProvider -> called.');
}
...
function ConfigurationItem(url, viewBoxSize) {
    ...
    this.url = url;
    this.viewBoxSize = viewBoxSize || ng.material.v111.ui.icon.config.defaultViewBoxSize;
}
...
MdIconProvider.prototype = {
    icon: function (id, url, viewBoxSize) {
        ...
        ng.material.v111.ui.icon.config[id] = new ConfigurationItem(url, viewBoxSize);
    ...
    defaultIconSet: function (url, viewBoxSize) {
        ...
        var setName = '$default',
			di_config = ng.material.v111.ui.icon.config;
    ...
    defaultViewBoxSize: function (viewBoxSize) {
        ...
        ng.material.v111.ui.icon.config.defaultViewBoxSize = viewBoxSize;
    ...
    fontSet: function fontSet(alias, className) {
        ...
        ng.material.v111.ui.icon.config.fontSets.push({
            alias: alias,
    ...
    defaultFontSet: function defaultFontSet(className) {
        ...
        ng.material.v111.ui.icon.config.defaultFontSet = !className ? '' : className;
    ...
    defaultIconSize: function defaultIconSize(iconSize) {
        ...
        ng.material.v111.ui.icon.config.defaultIconSize = iconSize;
    ...
    $get: ['$templateRequest', '$q', '$log', '$mdUtil', '$sce', function ($templateRequest, $q, $log, $mdUtil, $sce) {
		...
		var iconCache = {},
			...
			is_config = ng.material.v111.ui.icon.config;
...
function mdIconDirective($mdIcon, $mdTheming, $mdAria) {
    ...
    function postLink(scope_na, element, attr) {
        ...
        function parentsHaveText() {
			...
			if (parent.parent().attr('aria-label') || parent.parent().text()) {
                return true;
            }
            return false;
        }
        ...
        label = attr.alt || attr.mdFontIcon || attr.mdSvgIcon || element.text();
        attrName = attr.$normalize(attr.$attr.mdSvgIcon || attr.$attr.mdSvgSrc || '');
