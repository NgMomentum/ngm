...
msos.provide("ng.material.ui.colors");
msos.require("ng.material.core.theming");

ng.material.ui.colors.version = new msos.set_version(18, 3, 24);
    ...
    function MdColorsService($mdTheming, $mdUtil) {
        ...
        function applyThemeColors(element, colorExpression) {
            try {
                ...
                msos.console.error('ng.material.ui.colors - MdColorsService - applyThemeColors -> error:', e);
            }
            ...
            compile: function (tElem_na, tAttrs) {
                ...
                return function (scope, element, attrs, ctrl) {
                    ...
                    try {
                        if (shouldWatch) {
                            scope.$watch(
								parseColors, angular.bind(
									this,
									$mdColors.applyThemeColors,
									element
								),
								true
							);
                        ...
                        msos.console.error('ng.material.ui.colors - MdColorsDirective - compile -> error:', e);
                    }
