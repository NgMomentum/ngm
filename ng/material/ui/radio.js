...
msos.provide("ng.material.ui.radio");
msos.require("ng.material.core.ripple");    // ref. template
msos.require("ng.material.core.theming");
msos.require("ng.material.ui.aria");

ng.material.ui.radio.version = new msos.set_version(18, 6, 23);

// Load AngularJS-Material module specific CSS
ng.material.ui.radio.css = new msos.loader();
ng.material.ui.radio.css.load(msos.resource_url('ng', 'material/css/ui/radio.css'));
    ...
    function linkRadioGroup(scope, element, attr_na, ctrls) {
        ...
        element
            ...
            .on('mousedown', function () {
                ...
                $timeout(
					function ng_md_ui_radio_mousedown_to() {
						scope.mouseActive = false;
					},
					100,
					false
