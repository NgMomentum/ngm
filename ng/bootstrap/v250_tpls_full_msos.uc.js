 ...
 * License: MIT
 */angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse","ui.bootstrap.tabindex","ui.bootstrap.accordion","ui.bootstrap.alert","ui.bootstrap.buttons","ui.bootstrap.carousel","ui.bootstrap.dateparser","ui.bootstrap.isClass","ui.bootstrap.datepicker","ui.bootstrap.position","ui.bootstrap.datepickerPopup","ui.bootstrap.debounce","ui.bootstrap.multiMap","ui.bootstrap.dropdown","ui.bootstrap.stackedMap","ui.bootstrap.modal","ui.bootstrap.paging","ui.bootstrap.pager","ui.bootstrap.pagination","ui.bootstrap.tooltip","ui.bootstrap.popover","ui.bootstrap.progressbar","ui.bootstrap.rating","ui.bootstrap.tabs","ui.bootstrap.timepicker","ui.bootstrap.typeahead"]).directive(
    'templateUrl',
    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        modalRenderDeferObj.promise.then(function() {
          ...
          $q.when($q.defer('modalWinRenderDeferObj_animation'), animationPromise).then(function() {
      ...
      $get: ['$rootScope', '$q', '$document', '$templateRequest', '$controller', '$uibResolve', '$uibModalStack',
        function ($rootScope, $q, $document, $templateRequest, $controller, $uibResolve, $modalStack) {
          ...
          function getTemplatePromise(options) {
            return options.template ? $q.when($q.defer('$uibModal_when'), options.template) :
          ...
          $modal.open = function(modalOptions) {
            ...
            if (modalOptions.component) {
              templateAndResolvePromise = $q.when($q.defer('templateAndResolvePromise_when'), $uibResolve.resolve(modalOptions.resolve, {}, null, null));
            } else {
              templateAndResolvePromise =
                $q.all($q.defer('templateAndResolvePromise_all'), [getTemplatePromise(modalOptions), $uibResolve.resolve(modalOptions.resolve, {}, null, null)]);
            }
