...
msos.provide("ng.lr.dragndrop");

ng.lr.dragndrop.version = new msos.set_version(18, 1, 15);
...
(function (ng) {
    ...
    ng.module(
		...
		'lrDragSrc',
		['lrDragStore', 'lrDragHelper', function (store, dragHelper) {
			return {
		...
		'lrDropTarget',
		['lrDragStore', 'lrDragHelper', '$parse', function (store, dragHelper, $parse) {
			return {
