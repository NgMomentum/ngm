...
msos.provide("ng.lr.smarttable");

ng.lr.smarttable.version = new msos.set_version(18, 1, 15);
            ...
            function deepDelete(object, path) {
                if (path.indexOf('.') != -1) {
                    var partials = path.split('.'),
						key = partials.pop(),
						parentPath = partials.join('.'),
						parentObject = $parse(parentPath)(object);
		...
		['stConfig', '$timeout', '$parse', function (stConfig, $timeout, $parse) {
            return {
                ...
                link: function(scope, element, attr, ctrl) {
                    var tableCtrl = ctrl,
						promise = null,
						throttle = attr.stDelay || stConfig.search.delay,
						event = attr.stInputEvent || stConfig.search.inputEvent,
						trimSearch = attr.trimSearch || stConfig.search.trimSearch;
            ...
            return {
                ...
                link: function (scope, element, attr, ctrl) {
                    ...
                    var predicate = attr.stSort,
						...
						sortDefault,
						skipNatural = attr.stSkipNatural !== undefined ? attr.stSkipNatural : stConfig.sort.skipNatural,
						descendingFirst = attr.stDescendingFirst !== undefined ? attr.stDescendingFirst : stConfig.sort.descendingFirst,
						promise = null,
						throttle = attr.stDelay || stConfig.sort.delay;
