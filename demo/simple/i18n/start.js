...
msos.provide("demo.simple.i18n.start");
...
msos.onload_func_done.push(
    function () {
        ...
        var temp_dt = 'demo.simple.i18n.start -> ';

        msos.console.debug(temp_dt + 'start.');

        angular.module(
			'demo.simple.i18n.start',
			['ng', 'ng.translate']
		).config(
        ...
        angular.bootstrap('body', ['demo.simple.i18n.start']);
