...
msos.provide("demo.simple.dynamicI18n.start");
...
msos.onload_func_done.push(
    function () {
        ...
        var temp_di = 'demo.simple.dynamicI18n.start -> ';

        msos.console.debug(temp_di + 'start.');

		angular.module(
			'demo.simple.dynamicI18n.start',
			...
			'demo.simple.dynamicI18n.start.ctrl',
        ...
        angular.bootstrap('#body', ['demo.simple.dynamicI18n.start']);
