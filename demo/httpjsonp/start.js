...
msos.provide("demo.httpjsonp.start");

// Start by loading our demo.httpjsonp.start specific stylesheet
demo.httpjsonp.start.css = new msos.loader();
demo.httpjsonp.start.css.load(msos.resource_url('demo', 'httpjsonp/style.css'));
...
var MovieSearchService = function () {
    ...
    function MovieSearchService(apiKey, $http, $q) {
        ...
        msos._classCallCheck(this, MovieSearchService);
    ...
    msos._createClass(MovieSearchService, [{
        key: 'movieFetch',
...
var MainController = function MainController($scope, $rootScope, $element, movieSearch, forwardAnim, backwardAnim) {
    ...
    msos._classCallCheck(this, MainController);
...
var MoviesListController = function () {
    ...
    function MoviesListController($rootScope, $scope, $timeout, $element, $stateParams, resolvedResults, movieSearch) {
        ...
        msos._classCallCheck(this, MoviesListController);
...
var MovieDetailsController = function MovieDetailsController($rootScope, $stateParams, movieSearch) {
    ...
    msos._classCallCheck(this, MovieDetailsController);
...
var MovieController = function MovieController($rootScope, $stateParams) {
    ...
    msos._classCallCheck(this, MovieController);
...
msos.onload_func_done.push(
	function demo_start_onload() {
		...
		angular.bootstrap('#body', ['demo.httpjsonp.start']);
	}
);
