...
msos.provide("demo.firebase.fireauth");
...
(function() {
    ...
    function fireAuthConfig($routeProvider) {
        ...
        $routeProvider
            .when('/login', {
                templateUrl: msos.resource_url('demo', 'firebase/tmpls/login.html'),
                controller: 'AuthController',
                controllerAs: 'Auth'
            })
            .when('/register', {
                templateUrl: msos.resource_url('demo', 'firebase/tmpls/register.html'),
                controller: 'AuthController',
                controllerAs: 'Auth'
            })
            .when('/profile', {
                templateUrl: msos.resource_url('demo', 'firebase/tmpls/profile.html'),
                controller: 'AuthController',
                controllerAs: 'Auth'
            })
            .when('/home', {
                templateUrl: msos.resource_url('demo', 'firebase/tmpls/home.html'),
                controller: 'AuthController',
                controllerAs: 'Auth'
            })
            .when('/logout', {
    ...
    function fireAuth(DB, firePath, $rootScope, $firebaseAuth, $firebaseObject, $location, Flash) {
        ...
        function loginUser(data) {
            ...
            .then(function(loggedinUser) {
                ...
                var msg = err.message
                    .replace('.authWithPassword failed: ', '');
