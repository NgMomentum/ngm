...
msos.provide("demo.routercss.start");
msos.require("ng.ui.router.css");
msos.require("msos.google.prettify");
msos.require("ng.bootstrap.ui.dropdown");

demo.routercss.start.prettify = new msos.loader();
demo.routercss.start.prettify.load(msos.resource_url('css', 'prettify.css'));
demo.routercss.start.prettify.load(msos.resource_url('fonts', 'css/glyphicons.uc.css'));
...
msos.onload_functions.push(
	function () {
		...
		angular.module(
			'demo.routercss.start.utils.strings',
			['ng']
		).factory(
			's',
			function () {
...
msos.onload_func_post.push(
	function () {
		...
		angular.bootstrap('#body', ['demo.routercss.start']);
	}
);
