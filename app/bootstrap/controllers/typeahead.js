...
msos.provide("app.bootstrap.controllers.typeahead");
msos.require("ng.bootstrap.ui.typeahead");

app.bootstrap.controllers.typeahead.version = new msos.set_version(16, 4, 7);


angular.module(
    'app.bootstrap.controllers.typeahead', []
).controller(
    'app.bootstrap.controllers.typeahead.ctrl',
    [
        '$scope', '$http',
        function ($scope, $http) {
            "use strict";
