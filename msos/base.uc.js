...
/*
	...
	This file includes: Modernizr.js, Underscore.js, Purl.js, Verge.js, Basil.js
*/
...
msos.config = {
    ...
    storage: {
        ...
        site_pref: { name: 'site_pref', value: '', set: false },		// Site Preferences -> core.uc.js & core.min.js
        site_i18n: { name: 'site_i18n', value: '', set: false },		// i18n -> msos.i18n & msos.intl
		site_cltl: { name: 'site_cltl', value: '', set: false },		// Colortool -> msos.colortool.calc
		site_bdwd: { name: 'site_bdwd', value: '', set: false },		// Bandwidth -> core.uc.js & core.min.js
		site_ajax: { name: 'site_ajax', value: '', set: false },		// Ajax load times object -> core.uc.js & core.min.js 

		// These are base names
		site_tabs: { name: 'site_tab_'  },		// Tabs -> msos.tab
		site_sdmn: { name: 'site_sdm_'  },		// Slashdot Menu -> msos.sdmenu.js
		site_popu: { name: 'site_pop_'  }		// Popup Div's -> msos.popdiv
    },
...
(function (_global) {
    ...
    function parseString(str) {
        return _.reduce(String(str).split(/&|;/), function (ret, pair) {
            try {
...
msos.browser_preloading = function () {
	...
	script_pre.xhr_cache = (script_pre.available || (script_pre.ordered === false && (dua.indexOf("Opera") === -1) && (dua.indexOf("Gecko") === -1))) ? true : false;
